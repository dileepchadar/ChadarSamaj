          ...
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10">
              <div className="text-center md:text-left md:w-1/2">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                    <Link to="/search" className="bg-white text-red-600 px-8 py-3 rounded-full font-bold text-lg hover:bg-gray-100 shadow-lg transition-transform hover:scale-105 transform">{t('searchBtn')}</Link>
                    <Link to="/register" className="bg-red-800 text-white px-8 py-3 rounded-full font-bold text-lg hover:bg-red-900 border-2 border-red-700 shadow-lg transition-transform hover:scale-105 transform">{t('createBtn')}</Link>
                </div>
              </div>
