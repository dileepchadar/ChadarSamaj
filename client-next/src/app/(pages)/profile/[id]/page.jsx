            ...
            <div className="flex justify-between items-start">
                ...
                {user && user.userId === profile.userId && (
                    <div className="flex flex-col sm:flex-row gap-2 ml-2">
                        <button onClick={() => router.push('/edit-profile')} className="bg-primary text-white px-3 py-1 rounded text-sm whitespace-nowrap">{t('editProfile')}</button>
            ...
            <div className="mt-8 p-4 bg-blue-50 rounded-xl border border-blue-100 text-center">
                {user ? (
                    ...
                    <div>
                        ...
                        <button onClick={() => router.push('/login')} className="btn btn-secondary">{t('loginNow')}</button>
                    </div>
                )}
            </div>
